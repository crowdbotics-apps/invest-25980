"""invest_25980 URL Configuration
...
admin.site.site_header = "Invest"
admin.site.site_title = "Invest Admin Portal"
admin.site.index_title = "Invest Admin"

# swagger
api_info = openapi.Info(
    title="Invest API",
    default_version="v1",
    description="API documentation for Invest App",
)
